...
(103, 'Finance'),
(104, 'Marketing');
SELECT e.emp_id, e.name, d.dept_name FROM Employees e INNER JOIN Departments d ON e.dept_id = d.dept_id WHERE d.dept_name = 'IT';
...
SELECT e.emp_id, e.name FROM Employees e LEFT JOIN Departments d ON e.dept_id = d.dept_id WHERE e.dept_id IS NULL;